...
/***/ function(module, exports) {
	...
	exports.default = {
		...
		methods: {
			articleToggle: function articleToggle(event) {
				...
				if (this.articleFolded) {
					op.textContent = '收起全文 <<';
					this.$articleParagraphs.each(function (index) {
		...
		ready: function ready() {
			this.$articleParagraphs = $('.article-content > p');
			if (this.articleFolded) {
				this.$articleParagraphs.each(function (index) {
					if (index > 2) $(this).hide();
				});
