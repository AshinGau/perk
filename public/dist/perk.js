...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Reply = __webpack_require__(16);
	...
	var _Regist = __webpack_require__(22);
	...
	var _CommentTemplate = __webpack_require__(28);
	...
	var Vue = __webpack_require__(31),
	    VueRouter = __webpack_require__(146),
	    $ = __webpack_require__(155),
	    cookie_func = __webpack_require__(158);
	window.Vue = Vue;
	...
	Vue.component('comment-template', _CommentTemplate2.default);
	...
	exports.default = {
		...
		computed: {
			...
			cMe: function cMe() {
				var _cMe = [],
				    comments = this.cAll;
				if (window.$.cookie('user')) for (var key in comments) {
		...
		watch: {
			articleFolded: function articleFolded(val) {
				if (val) this.articleOp = '展开全文 >>';else this.articleOp = '收起全文 <<';
			}
		},
		methods: {
			articleToggle: function articleToggle(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/Message.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-aa174d90/Message.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/User.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/Comment.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5c605b90/Comment.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5dfb372a/CommentTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isExtensible = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(46), 'Object', {defineProperties: __webpack_require__(70)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(38).Object.freeze;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(41)(IteratorPrototype, __webpack_require__(89)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(38).Object.isExtensible;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (a, b) {
	  ...
	  var c = [],
	    ...
	    return this.length;
	  }, m.fn.andSelf = m.fn.addBack, "function" == "function" && __webpack_require__(157) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return m;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cookie_func = function cookie_func($) {
